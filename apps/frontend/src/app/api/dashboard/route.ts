// ============================================================
// LEGALIR — GET /api/dashboard
// ============================================================
// Returns dashboard summary with recent drafts and subscription info.
// Requires a valid session cookie.
// ============================================================

import { NextResponse } from "next/server";
import { findSessionById, cleanupExpiredSessions, queryDashboard } from "@/lib/db";
...
export async function GET(request: Request) {
  try {
    ...
    const data = queryDashboard(session.userId);
